...
namespace Phakisa
{
    public partial class scrTeamD : Form
    {
        ...
        private DataTable _newDataTable = new DataTable();
        ...
        internal void scrTeamDLoad(string Period, string Region, string BussUnit, string Userid, string MiningType, string BonusType, string Environment)
        {
            ...
            txtDatabaseName.Text = "DEVTM2000";
            ...
            buttonCollection["DrillersEARN20"] = btnDrillerCalcs;
            ...
            buttonCollection["BonusShiftsEARN90"] = btnBonusShiftsCalcs;
            buttonCollection["Bonus Report Process - Phase 1"] = btnBonusPrints;
        ...
        private void setEnvironment()
        {
            ...
            Base.StopeDatabaseName = "STPTM2000";
            Base.DevDatabaseName = "DEVTM2000";
            ...
            string strPath = "c:\\iCalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\" + strdb.Replace(BusinessLanguage.Period, "").Replace("2000", "Conn") + ".udl";
            ...
            if (intCount > 0)
            {
                ...
                if (Survey.Rows.Count > 0)
                {
                    ...
                    if (Section.Rows.Count > 0)
                    {
                        ...
                        //Load workplace and description into listbox of Abnormal linking.

                        foreach (DataRow dr in Survey.Rows)
                        {
                            string s = dr["workplace"].ToString().Trim() + "-" + dr["description"].ToString().Trim();
                            if (lstWorkplaces.Items.Contains(s.Trim()))
                            {
                            }
                            else
                            {
                                lstWorkplaces.Items.Add(s);
                            }                            
                        }
                    }
                    else
        ...
        private void evaluateClockedShifts()
        {
            ...
            if (intCount > 0)
            {
                ...
                {
                    Clocked = TB.createDataTableWithAdapterSelectAll(Base.DBConnectionString, "Clockedshifts", strWhere + " order by employee_no");
                }
                else
                {
        ...
        private void evaluateLabour()
        {
            ...
            if (intCount > 0)
            {
                ...
                string strSQL = "select * from BONUSSHIFTS " + strWhere + " order by employee_no";
        ...
        private void refreshSurvey()
        {
            ...
            string FilePath = "C:\\iCalc\\Harmony\\Phakisa\\" + strServerPath + "\\Data\\productionDEV_" + BusinessLanguage.Period.Trim() + ".xls";
            ...
            */
            ...
            {
                if (string.IsNullOrEmpty(row["PENALTYMETERS"].ToString()))
                {
                    row["PENALTYMETERS"] = "0";
                }
                row["MININGTYPE"] = "DEVELOPMENT";
                row["BONUSTYPE"] = "TEAM";
                if (row["GANG"].ToString().Length < 5)
                {
                    row["SECTION"] = "XXXXXX";
...
//========================================================================
        ...
        private void refreshLabour()
        {
            ...
            bool XLSX_exists = File.Exists("C:\\iCalc\\Harmony\\Phakisa\\" + strServerPath + "\\Data\\master" + BusinessLanguage.Period.Trim() + ".xlsx");//JVDW
            bool XLS_exists = File.Exists("C:\\iCalc\\Harmony\\Phakisa\\" + strServerPath + "\\Data\\master" + BusinessLanguage.Period.Trim() + ".xls");//JVDW
            ...
            */
            ...
            IEnumerable<DataRow> query1 = from locks in dt.AsEnumerable()
                                          where locks.Field<string>("GANG NAME").TrimEnd().Substring(2, 1) == "U"
                                          select locks;
            ...
            switch (tabInfo.SelectedTab.Name)
            {
                case "tabMiners":
                        ...
                        txtMinersSafetyInd.Text.Trim().Length != 0)
                    {
                        ...
                        int rowindex = 0;
                        if (grdMiners.CurrentCell.RowIndex.ToString() == null)
                        {
                            rowindex = 0;
                        }
                        else
                        {
                            rowindex = grdMiners.CurrentCell.RowIndex;
                        }
                ...
                case "tabAbnormal":
                    ...
                    if(lstWorkplaces.SelectedItems.Count > 0)
                    {
                        ...
                        //Get the layout of the abnormal file.
                        ...
                        temp.AcceptChanges();
                        for (int i = 0; i < lstWorkplaces.SelectedItems.Count; i++)
                        {
                            DataRow dr = temp.NewRow();
                            string strWorkplace = lstWorkplaces.SelectedItems[i].ToString().Trim().Substring(0,lstWorkplaces.SelectedItems[i].ToString().IndexOf("-"));
                            dr["BUSSUNIT"] = BusinessLanguage.BussUnit.Trim();
                            dr["MININGTYPE"] = BusinessLanguage.MiningType.Trim();
                            dr["BONUSTYPE"] = BusinessLanguage.BonusType.Trim();
                            dr["SECTION"] = txtSelectedSection.Text.Trim();
                        ...
                        TB.saveCalculations2(temp, Base.DBConnectionString, strDelete, "ABNORMAL");
                        evaluateAbnormal();
                    }
                    else
                    {
        ...
        private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listBox2.SelectedIndex >= 0)
            {
                ...
                {
                    if (Calendar.Rows[i]["SECTION"] == txtSelectedSection.Text.Trim() && 
                        Calendar.Rows[i]["PERIOD"] == BusinessLanguage.Period.Trim())
                    {
                        intRowPosition = i;
                    }
                }
            ...
            switch (tabInfo.SelectedTab.Name)
            {
                ...
                case "tabLabour":
                    ...
                    if (txtEmployeeNo.Text.Trim().Length > 0
                        ...
                        && txtDrillerShifts.Text.Trim().Length > 0 && cboTLeader.Text.Trim().Length > 0)
                    {

                        intRow = grdLabour.CurrentCell.RowIndex;

                        //InputBoxResult result = InputBox.Show("Password: ");
                        ...
                        string strTMLeaderInd = Convert.ToString(grdLabour["TMLEADERIND", intRow].Value);
                        ...
                        strSQL = "Update bonusshifts set wagecode = '" + cboBonusShiftsWageCode.Text.Trim() +
                                 ...
                                 "' , TMLEADERIND = '" + cboTLeader.Text.Trim() +
                        ...
                        grdLabour["TMLEADERIND", intRow].Value = cboTLeader.Text.Trim();
        ...
        private void btnBaseCalcsHeader_Click(object sender, EventArgs e)
        {
                ...
                if (intCheckLocks == 0)
                {
                    ...
                    if (intCount1 > 0 ||intCount2 > 0 ||intCount3 > 0 ||intCount4 > 0 ||intCount5 > 0)
                    {
            ...
            private void startCalcProcess()
            {
                ...
                Calcs("Production", "ProductionEarn777", "N");
                Calcs("BonusShifts", "BonusShiftsEARN5", "Y");
                Calcs("GangLink", "GanglinkEARN4", "Y");
                Calcs("GangLink", "GanglinkEARN5", "N");
                Calcs("GangLink", "GanglinkEARN10", "N");
                Calcs("GangLink", "GanglinkEARN20", "N");
                Calcs("GangLink", "GanglinkEARN25", "N");
                Calcs("GangLink", "GanglinkEARN30", "N");
                Calcs("GangLink", "GanglinkEARN40", "N");
                Calcs("GangLink", "GanglinkEARN41", "N");
                Calcs("GangLink", "GanglinkEARN42", "N");
                Calcs("GangLink", "GanglinkEARN50", "N");
                Calcs("GangLink", "GanglinkEARN60", "N");
                Calcs("GangLink", "GanglinkEARN70", "N");
                Calcs("GangLink", "GanglinkEARN80", "N");
                Calcs("GangLink", "GanglinkEARN90", "N");
                Calcs("GangLink", "GanglinkEARN92", "N");
                Calcs("GangLink", "GanglinkEARN95", "N");
                Calcs("SupportLink", "SupportLinkEARN10", "Y");
                Calcs("SupportLink", "SupportLinkEARN20", "N");
                Calcs("SupportLink", "SupportLinkEARN30", "N");
                Calcs("SupportLink", "SupportLinkEARN40", "N");
                Calcs("SupportLink", "SupportLinkEARN50", "N");
                ...
                Calcs("Drillers", "DrillersEARN15", "N");
                Calcs("Drillers", "DrillersEARN20", "N");
                Calcs("Miners", "MinersEARN10", "Y");
                ...
                btnDrillerCalcs.BackColor = Color.Orange;

                TB.updateStatusFromArchive(Base.DBConnectionString, "N", "DrillerEARN10", txtSelectedSection.Text.Trim(), BusinessLanguage.Period.Trim(), "");
                ...
                TB.updateStatusFromArchive(Base.DBConnectionString, "N", "DrillersEARN20", txtSelectedSection.Text.Trim(), BusinessLanguage.Period.Trim(), "");
        ...
        private void execute()
        {
            ...
            switch (BusinessLanguage.Env)
            {
                ...
                case "Development":
                    ...
                    strName = "PhakisaDEVTMD";
                    P.StartInfo.WorkingDirectory = @"C:\iCalc\Harmony\Phakisa\Core";
                    P.StartInfo.FileName = strName + ".exe";
        ...
        private void btnSupportPrint_Click(object sender, EventArgs e)
        {
            ...
            Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "DEVTEAMSupport_" + txtSelectedSection.Text.Trim() + ".PDF",
                                "DEVTEAMSupport", strMetaReportCode,  "c:\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
        ...
        private void btnTeamPrint_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show("Server Path:" + Base.Drive.Trim() +
                //                "\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
            
            Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "DEVTEAM_" + txtSelectedSection.Text.Trim() + ".PDF",
                                "bDEVTEAM_Server", strMetaReportCode, 
                                "C:\\icalc\\Harmony\\Phakisa\\Production\\REPORTS\\");
        ...
        private void btnDrillerPrint_Click(object sender, EventArgs e)
        {
            ...
            this.Cursor = Cursors.Arrow;
            Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "DEVTEAMDrillers_" + txtSelectedSection.Text.Trim() + ".PDF",
                                "DEVTM_Drillers", strMetaReportCode,
                                "c:\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
        ...
        {
            this.Cursor = Cursors.WaitCursor;
            Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "DEVTEAM_Miner" + txtSelectedSection.Text.Trim() + ".PDF",
                                "DEVTEAM_Miners", strMetaReportCode,
                                "c:\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
            this.Cursor = Cursors.Arrow;
        }
        ...
        private void btnSupportAuth_Click(object sender, EventArgs e)
        {
            ...
            metareportAutoW3Parameter("Section_value", "GangType", "Period", txtSelectedSection.Text.Trim(), 
                                      "Tramming", Base.Period, "", "DEVTMSupportAuthorization");
        }
        ...
        private void cboNames_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Clocked.Rows.Count > 0)
            {
                IEnumerable<DataRow> query1 = from locks in Clocked.AsEnumerable()
                                              where locks.Field<string>("EMPLOYEE_NO").Trim() == cboNames.Text.Trim()
                                              select locks;
                try
                {
                    temp = query1.CopyToDataTable<DataRow>();
            ...
            if (Labour.Rows.Count > 0)
            {
                ...
                catch
                {
                    ...
                    MessageBox.Show("The employee: " + cboNames.Text.Trim() + " was not found under this section.");
                }
            }
        ...
        private void btnAttendance_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "AttendanceDevTM_" + txtSelectedSection.Text.Trim() + ".PDF",
                                                "DEVTMTA",strMetaReportCode,"c:\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
            ...
            if (intCount > 0)
            {
                ...
                if (Abnormal.Rows.Count == 0)
                {
                    string strSQL = "Begin Transaction; Delete from abnormal where section = '" + txtSelectedSection.Text.Trim() + 
                                    ...
                                    "from Survey where section = '" + txtSelectedSection.Text.Trim() +
                                    "' and period = '" + BusinessLanguage.Period.Trim() + 
                                    "'; Commit Transaction;  ";
        ...
        private void refreshShifts()
        {
            ...
            bool XLSX_exists = File.Exists("C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\master" + BusinessLanguage.Period.Trim() + ".xlsx");
            bool XLS_exists = File.Exists("C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\master" + BusinessLanguage.Period.Trim() + ".xls");

            if (XLSX_exists.Equals(true))
            {
                string status = excel.OpenFile("C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\master" + BusinessLanguage.Period.Trim() + ".xlsx", "BONTS2011");
                excel.SaveFile(BusinessLanguage.Period.Trim(), strServerPath);
                excel.CloseFile();
            }
            ...
            {
                //MessageBox.Show("nou in xls filepath");
                string status = excel.OpenFile("C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\master" + BusinessLanguage.Period.Trim() + ".xls", "BONTS2011");
            ...
            string FilePath_XLSX = "C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xlsx";

            string FilePath_XLS = "C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xls";
            ...
            if (XLS_exists.Equals(true))
            {
                FilePath = "C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xls";
            }

            if (XLSX_exists.Equals(true))
            {
                FilePath = "C:\\iCalc\\Harmony\\Phakisa\\Development\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xlsx";
            }
        ...
        private void cboMinersEmpName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Clocked.Rows.Count > 0)
            {
                IEnumerable<DataRow> query1 = from locks in Labour.AsEnumerable()
                                              where locks.Field<string>("EMPLOYEE_NAME").Trim() == cboMinersEmpName.Text.Trim()
                                              select locks;
        ...
        private void grdDrillers_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                IEnumerable<DataRow> query1 = from locks in Labour.AsEnumerable()
                                              where locks.Field<string>("GANG").Trim() == grdDrillers["GANG", e.RowIndex].Value.ToString().Trim()
                                              select locks;
        ...
        private void btnDrillersRefresh_Click(object sender, EventArgs e)
        {
            ...
            if (GangLink.Rows.Count > 0)
            {
                ...
                List<string> lstSupport = TB.loadDistinctValuesFromColumn(SupportLink, "GANG");
                ...
                for (int i = 0; i <= lstSupport.Count - 1; i++)
                {
                    if (lstTemp.Contains(lstSupport[i].ToString().Trim()))
                    {
                    ...
                    else
                    {
                        ...
                        dr["PERIOD"] = txtPeriod.Text.Trim();
                        //dr["WORKPLACE"] = s;
                        dr["GANG"] = lstSupport[i].ToString().Trim();
                        dr["EMPLOYEE_NO"] = "XXX";
                        dr["DRILLERIND"] = "1";
                        dr["DRILLERSHIFTS"] = "0";
        ...
        private void graphTransfer_Click(object sender, EventArgs e)
        {
            ...
            string ServerPath = "z:\\Harmony\\Phakisa\\Production\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xls";
            string FilePath_XLSX = "C:\\iCalc\\Harmony\\Phakisa\\" + strServerPath + "\\Data\\adteam_" + BusinessLanguage.Period.Trim() + ".xlsx";

            //Select the from database name
            OpenFileDialog openFile1 = new OpenFileDialog();
            openFile1.InitialDirectory = "C:\\icalc\\harmony\\Phakisa\\Publish";
        ...
        {
            lstWorkplaces.SelectedItems.Clear();
        }
        ...
        private void btnDrillers_Click(object sender, EventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            Shared.metareportAutoWParameter("Section_value", txtSelectedSection.Text.Trim(), "DEVTMTADRILLERS_" + txtSelectedSection.Text.Trim() + ".PDF",
                                            "DEVTMTADRILLERS", strMetaReportCode, "c:\\icalc\\Harmony\\Phakisa\\" + strServerPath + "\\REPORTS\\");
