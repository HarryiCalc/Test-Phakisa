...
namespace Phakisa
{
	...
	public class InputBox
	{
        ...
        private static string _passwordChar = " ";
		...
		static private void LoadForm()
		{
            ...
            {
                txtInput.PasswordChar = Convert.ToChar(_passwordChar);
            }
        ...
        static public InputBoxResult Show(string Prompt, string Title, string PassChar, string Default)
        {
            InitializeComponent();
        ...
        static private string PasswordChar
        {
            set
            {
                _passwordChar = value;
